...
import { IEquipmentReport } from "../../../lib/API/Report";
...
const EquipmentReport: React.FC<{ equipmentReport: IEquipmentReport[] }> = ({
  ...
  const filteredReport = useMemo(() => {
    let filteredMaterials = equipmentReport ?? [];
  ...
  const renderCell = useCallback(
    (report: IEquipmentReport, columnKey: React.Key) => {
      const cellValue = report[columnKey as keyof IEquipmentReport];
      switch (columnKey) {
        case "description":
          return <div>{report.eqptDescript}</div>;
        case "quantity":
          return <div>{report.eqptQuantity}</div>;
        case "assignedPrice":
          return <div>₱ {report.assignedPrice}</div>;
        case "unit":
          return <div>{report.eqptUnit}</div>;
        case "category":
          return <div>{report.eqptCategory}</div>;
        case "qoh":
          return <div>{report.eqptqoh}</div>;
        case "price":
